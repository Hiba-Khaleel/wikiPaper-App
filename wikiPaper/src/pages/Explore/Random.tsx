...
//         "https://en.wikipedia.org/w/api.php?action=query&origin=*&generator=random&format=json&grnnamespace=0&prop=extracts|images&pithumbsize=2000&grnlimit=3"
//       );
...
//         <Button onClick={fetchRandomArticles} text="generate new" />
//         <Button onClick={fetchRandomArticles} text="latest Articles" />
//       </div>
